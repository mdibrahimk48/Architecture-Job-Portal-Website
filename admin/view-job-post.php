                    ...
                    <div class="col-md-9 bg-white padding-2">
                        ...
                        <div class="pull-right">
                            <a href="active-jobs.php" class="btn btn-default btn-lg btn-flat margin-top-20"><i
                                        class="fa fa-arrow-circle-left"></i><b> Back</b></a>
                        </div>
                        <div class="clearfix"></div>
                        <hr>
                        <div>

                            <!--strtotime() function parses an English textual datetime-->
                            <p><span class="margin-right-10"><i
                        ...
                        <div>
                            <!--  stripcslashes()Remove the backslash-->
