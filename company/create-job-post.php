      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="create-job-post.php"><i class="fa fa-file-o"></i><b> Create Job Post</b></a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <center><h2><i><b><u>Create Job Post</u></b></i></h2></center>
            <div class="row">
              <form method="post" action="addpost.php">
                ...
                <input type="number" class="form-control  input-lg" id="experience" autocomplete="off" name="experience" placeholder="Experience (in Years) Required" required="">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-success"><b>CREATE</b></button>
                  </div>
                </div>
              </form>
            </div>
