    ...
    <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          <h1 class="text-center margin-bottom-20"><b>ACCOUNT CREATION</b></h1>
          <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <input class="form-control input-lg" type="text" id="qualification" name="qualification" placeholder="Academic Qualification *" required>
              </div>
              <div class="form-group">
                <input class="form-control input-lg" type="text" id="stream" name="stream" placeholder="Architect Licence No from RAJUK. e.g. AR 6785 76 0543 *" required>
              </div>                    
              <div class="form-group checkbox">
                <label><input type="checkbox"> I Accept Terms & Conditions.</label>
              </div>
              <div class="form-group">
                <button class="btn btn-flat btn-success"><b>SUBMIT</b></button>
              </div>
              <?php 
