      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="edit-company.php"><i class="fa fa-tv"></i><b> My Company</b></a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <center><h2><i><b><u>My Company</u></b></i></h2></center>
            ...
            <div class="row">
              <form action="update-company.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-success"><b>Update Company Profile</b></button>
                  </div>
                </div>
                <div class="col-md-6 latest-job ">
                  <div class="form-group">
