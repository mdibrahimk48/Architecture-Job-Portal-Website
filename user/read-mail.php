      ...
      <div class="container">
        <div class="row">
          ...
          <section class="content">
            <div class="row">
              <div class="col-md-12">
                <a href="mailbox.php" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i><b> Back</b></a>
                  ...
                  <div class="box-body no-padding">
                    ...
                    <div class="mailbox-read-message">
                      <form action="reply-mailbox.php" method="post">
                        ...
                        <div class="form-group">
                          <button type="submit" class="btn btn-flat btn-success"><b>REPLY</b></button>
                        </div>
                      </form>
                    </div>
                    <!-- /.mailbox-read-message -->
