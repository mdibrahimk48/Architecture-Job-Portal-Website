      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="active-jobs.php"><i class="fa fa-briefcase"></i><b> Active Jobs</b></a></li>
                  <li><a href="applications.php"><i class="fa fa-address-card-o"></i><b> Applications</b></a></li>
                  <li class="active"><a href="companies.php"><i class="fa fa-building"></i><b> Companies</b></a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <center><h3><b>Companies</b></h3></center>
