      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  <li class="active"><a href="edit-profile.php"><i class="fa fa-user"></i><b> Edit Profile</b></a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <center><h1><i><b><u>Edit Profile</u></b></i></h1></center>
            ...
            ?>
              <div class="row">
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-success"><b>Update Profile</b></button>
                  </div>
                </div>
                <div class="col-md-6 latest-job ">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="stream">Licence No.</label>
                    <input type="text" class="form-control input-lg" id="stream" name="stream" placeholder="Licence No." value="<?php echo $row['stream']; ?>">
                  </div>
                  <div class="form-group">
                    <label>Skills</label>
