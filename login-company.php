...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg"><big><b>Company Login</b></big></p>
      ...
      <div class="row">
        ...
        <?php 
              ...
              if(isset($_SESSION['registerCompleted'])) {
                ?>
                <div>
                  <p class="text-center" style="color:red">You Have Registered Successfully! Your Account Approval Is Pending By Admin!</p>
                </div>
              <?php
