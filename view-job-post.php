        ...
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            ...
            <div class="pull-right">
              <a href="jobs.php" class="btn btn-default btn-lg btn-flat margin-top-20"><i class="fa fa-arrow-circle-left"></i><b> Back</b></a>
            </div>
            ...
            <div>
              <a href="apply.php?id=<?php echo $row['id_jobpost']; ?>" class="btn btn-success btn-flat margin-top-50"><b>Apply</b></a>
            </div>
            <?php } ?>
